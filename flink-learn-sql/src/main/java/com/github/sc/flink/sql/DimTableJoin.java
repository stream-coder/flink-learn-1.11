...
public class DimTableJoin {
    ...
    public static final String CSV_TABLE_SOURCE_DDL = "" +
            ...
            " 'connector.path' = '/Users/wg/code/stream-coder/flink-learn-1.11/flink-learn-sql/src/main/resources/UserBehavior.csv',-- 目录 \n" +
...
//            "  'update-mode' = 'upsert' -- 指定为插入更新模式 \n"+
    ...
    //  `count_unique_user` int(11),
    //  `e_name` varchar(255) COLLATE utf8_bin
    //);
